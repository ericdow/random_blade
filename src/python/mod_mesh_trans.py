import perturb_surf_trans
import os, shutil

def modify(src,inp,cg_mesh_orig,cg_mesh_mod,rpath,wpath,scale,mode):
    ...
    perturb_surf_trans.perturb(inp+rpath, inp+wpath, inp+'transformed_modes/', scale, mode)
